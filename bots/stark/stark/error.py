...
class StarkException(Exception):
    """Base exception class for Stark"""


class BackupError(StarkException):
    """Unexpected backup data type"""


class EventDispatchError(StarkException):
    """Exception raised when a dispatcher raised an exception"""


class CommandHandlerError(StarkException):
    """Exception raised when the command handler raised an exception."""


class CommandInvokeError(StarkException):
    """Exception raised when the command being invoked raised an exception."""


class PluginLoadError(StarkException):
    """Base exception class for every Plugin errors"""


class BadArgument(StarkException):
