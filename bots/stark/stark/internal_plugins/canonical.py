...
from Stark import command, filters, listener, plugin
from stark.core.metrics import MessageStat
...
class Canonical(plugin.Plugin):
    """Helper Plugin
    This plugin is only available for @dstark_bot
    ...
    async def cmd_login(self, ctx: command.Context):
        ...
        await ctx.respond(
            "Click this button to login to Stark Dashboard",
