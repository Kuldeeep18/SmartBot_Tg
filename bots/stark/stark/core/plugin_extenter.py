...
from Stark import custom_plugins, internal_plugins, plugin, plugins, util
from stark.error import ExistingPluginError
...
class PluginExtender(MixinBase):
    ...
    def load_plugin(
        self: "Stark", cls: Type[plugin.Plugin], *, comment: Optional[str] = None
    ) -> None:
    ...
    def unload_plugin(self: "Stark", plug: plugin.Plugin) -> None:
        cls = type(plug)
    ...
    def _load_all_from_metaplug(
        self: "Stark", subplugins: Iterable[PluginType], *, comment: Optional[str] = None
    ) -> None:
    ...
    def load_all_plugins(self: "Stark") -> None:
    ...
    def unload_all_plugins(self: "Stark") -> None:
    ...
    async def reload_plugin_pkg(self: "Stark") -> None:
