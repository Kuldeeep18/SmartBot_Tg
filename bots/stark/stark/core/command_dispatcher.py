...
from Stark import command, plugin, util
from stark.error import CommandHandlerError, CommandInvokeError, ExistingCommandError
...
class CommandDispatcher(MixinBase):
    ...
    def unregister_command(self: "Stark", cmd: command.Command) -> None:
    ...
    def register_commands(self: "Stark", plug: plugin.Plugin) -> None:
    ...
    def unregister_commands(self: "Stark", plug: plugin.Plugin) -> None:
    ...
    def command_predicate(self: "Stark") -> Filter:
        async def func(_: Filter, client: Client, message: Message) -> bool:
            ...
            if message.text is not None and message.text.startswith("/"):
                ...
                try:
                    ...
                    # eg: /ping@dstark_bot will return True
                    # If current bot instance is dstark_bot else False
    ...
    async def on_command(
        self: "Stark", client: Client, message: Message  # skipcq: PYL-W0613
    ) -> None:
