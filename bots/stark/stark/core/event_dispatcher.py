...
from Stark import plugin, util
from stark.error import EventDispatchError
from stark.listener import Listener, ListenerFunc
from stark.util.misc import StopPropagation
...
class EventDispatcher(MixinBase):
    ...
    def unregister_listener(self: "Stark", listener: Listener) -> None:
    ...
    def register_listeners(self: "Stark", plug: plugin.Plugin) -> None:
    ...
    def unregister_listeners(self: "Stark", plug: plugin.Plugin) -> None:
    ...
    async def dispatch_missed_events(self: "Stark") -> None:
...
```
    ...
    async def log_stat(self: "Stark", stat: str, *, value: int = 1) -> None:
